...
function App() {
  ...
  return (
    <div>
      <Header />
      <main>
        <h1 className='w-5/6 mt-8 mx-auto px-2 py-1 text-xl md:text-2xl text-title-clr font-semibold font-montserrat border-l-4 border-l-routine-green'>Select Your After School Activities</h1>
