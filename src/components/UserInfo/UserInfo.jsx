...
const UserInfo = () => {
  return (
    <div>
      <div className='flex gap-3 items-center shadow-sm p-2 mb-3'>
        ...
        <div>
          ...
          <p className='text-gray-500 text-sm'><FontAwesomeIcon className='text-lime-400 mr-1' icon={faLocationDot} />Chattogram, Bangladesh</p>
        </div>
      </div>
