  ...
  return (
    <div className="font-noto text-gray-600 p-2 shadow-sm flex flex-col">
      ...
      <div className="p-2 mt-2 flex flex-col justify-between flex-grow">
        ...
        <p className=" mb-2">Active Time: <span className="font-medium text-gray-900">{timeNeeded} min</span></p>
        <button className="bg-blue-200 hover:bg-blue-300 w-full py-2 font-semibold shadow-sm">Add To Routine</button>
      </div>
    </div>
  );
};
